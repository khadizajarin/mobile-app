...
import { StyleSheet, Text, View, Button, TouchableOpacity,  ActivityIndicator } from 'react-native'; // Add ActivityIndicator
          ...
          <>
            ...
            {weather && (
              <View style={styles.weatherContainer}>
                <Text style={styles.weatherText}>Get to know abouthe weather {'\n'}of your current location:</Text>
